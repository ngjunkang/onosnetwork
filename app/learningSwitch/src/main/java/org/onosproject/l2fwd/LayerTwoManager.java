...
public class LayerTwoManager implements LayerTwoService {
    ...
    private class LayerTwoPacketProcessor implements PacketProcessor {
        ...
        public void forward(PacketContext pc) {
             ...
             */
            MacAddress srcMacAddress = pc.inPacket().parsed().getSourceMAC();
            MacAddress dstMacAddress = pc.inPacket().parsed().getDestinationMAC();
            ...
            macTable.put(srcMacAddress, new MacTableEntry(cp.port(), Duration.ofSeconds(60)));
             ...
             */
            if (macTable.containsKey(dstMacAddress)) {
